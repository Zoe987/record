...
<tr><td height="2"></td></tr>
          <tr>
            <td width="740" class="a9"><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $info["title"];?>&nbsp;版块</div></td>
            <td width="160"><div align="center"><span class="a13">【</span>&nbsp;<a href="
			
			<?php
			  if($_SESSION["unc"]!=""){
			?>
			  bbs_pubbs.php?ids=<?php echo $info["title"];?>&id=<?php echo $info["id"];?>
			<?php
			  }else{
  ...
  <tr>
    ...
    <td height="23" bgcolor="#E9F3FF" class="a12">&nbsp;<img src="images/jia.gif" border="0" alt="展开" id="img<?php echo $info["id"];?>" onclick="ShowTR(img<?php echo $info["id"];?>,tr<?php echo $info["id"];?>)" />
        <?php 
			...
			if($info["top"]==1){
			 echo "<a href=\"bbs_lookbbs.php?id=".$info["id"]."\" class=a1>".$info["title"]."";
			}else{
			echo "<a href=\"bbs_lookbbs.php?id=".$info["id"]."\" class=a1>".$info["title"];
			}
			?>
