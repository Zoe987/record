      ...
      <tr>
        <td height="40"><br>
          ...
          <tr>
            ...
            <td width="386" height="25" bgcolor="#FFFFFF">&nbsp;<?php echo $info["bccdname"];?></td>
          </tr>
          <tr>
            <td height="25" bgcolor="#FFFFFF"><div align="center">版权：</div></td>
            <td height="25" bgcolor="#FFFFFF">&nbsp;<?php echo $info["owner"];?></td>
          </tr>
          <tr>
          ...
          <table width="680" height="120" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
            <tr>
              <td bgcolor="#FFFFFF" valign="top"><div style="line-height:1.6; padding:5" ><font color="red">版本共同点：</font><?php echo $info["samepart"];?></div></td>
            </tr>
          </table>
          ...
          <table width="680" height="120" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#999999">
            <tr>
              <td bgcolor="#FFFFFF"><div style="line-height:1.6; padding:5" ><font color="red">内容简介：</font><?php echo $info["content"];?></div></td>
            </tr>
          </table>	
		  <br>		  	  </td>
      </tr>
