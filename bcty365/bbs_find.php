...
<table width="450" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<table width="750" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#6EBEC7">
      ...
      <?php
		...
		?>
      <tr>
        <td height="23" align="right" bgcolor="#F7F7F7"><div align="left">&nbsp;&nbsp;<a href="bbs_lookbbs.php?id=<?php echo $info2["id"];?>" class="a1"><?php include_once("function.php"); echo $info2["title"];?></a></div></td>
