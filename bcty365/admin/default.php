...
<tr>
    <td>
        <img src="images/bg_16_2.jpg" alt="" width="830" height="139" usemap="#Map" border="0"/>
        <map name="Map" id="Map">
          <area shape="rect" coords="687,9,739,27" href="index.php" alt="关闭系统">
          <area shape="rect" coords="756,8,808,28" href="index.php" alt="重新登录">          
          <area shape="rect" coords="637,110,725,139" href="../index.php" alt="网站首页">
          <area shape="rect" coords="724,110,814,137" href="index.php" alt="退出登录">
        </map>
    </td>
</tr>
</table>
