...
<body topmargin="0" leftmargin="0" bottommargin="0" class="scrollbar">
     <table width="565" height="22" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#327387">
	  ...
	  <table width="565" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#327387">
		...
		<tr>
          <td height="22" bgcolor="#FFFFFF"><div align="center"><?php  echo $info["bccdname"];?></div></td>
	  ...
	  <table width="565" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#327387">
		...
		<tr>
          ...
          <td height="22" bgcolor="#FFFFFF"><div align="center"><?php echo $info1["content"];?></div></td>
          <td height="22" bgcolor="#FFFFFF"><div align="center"><?php echo $info1["gn"];?></div></td>
          <td height="22" bgcolor="#FFFFFF"><div align="center"><?php echo $info1["fw"];?></div></td>
