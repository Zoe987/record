    ...
    <?php
	 ...
	 ?>
        ...
        <tr>
          ...
          <td width="231" bgcolor="#CCCCCC">&nbsp;<?php echo $myrow["usernc"];?></td>
          <td width="120" bgcolor="#CCCCCC"><div align="center">真实姓名：</div></td>
          <td width="174" bgcolor="#CCCCCC">&nbsp;<?php echo $myrow["truename"];?></td>
        ...
        <tr>
          ...
          <td height="20" colspan="2" bgcolor="#ffffff">&nbsp;<?php echo $myrow["yb"];?></td>
        </tr>
        <tr>
          <td height="20" bgcolor="#ffffff"><div align="center">联系地址：</div></td>
          <td height="20" colspan="4" bgcolor="#ffffff">&nbsp;<?php echo $myrow["address"];?></td>
        </tr>
        <tr>
          <td height="20" bgcolor="#ffffff"><div align="center">反馈主题：</div></td>
          <td height="20" colspan="4" bgcolor="#ffffff">&nbsp;<?php echo $info["title"];?></td>
        </tr>
        <tr>
          <td bgcolor="#ffffff"><div align="center">反馈内容：</div></td>
          <td colspan="4" bgcolor="#ffffff">&nbsp;<?php echo $info["content"];?></td>
        </tr>   <?php
	      }
	  	}
	  ?>
