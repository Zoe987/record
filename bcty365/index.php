				   ...
				   if($i==1)
				    {
					  echo "<font color=red>";
						...
						echo msubstr($infouwz["softname"],0,16);
...
<!-- 编程词典模块开始 -->
      <table width="610" height="200" border="0" cellpadding="0" cellspacing="0">      
       ...
       <tr>  
                <td width="175" rowspan="3"><div align="center"><a href="bccdinfo.php?id=7"><img src="admin/bccdimages/20071221029426747499.jpg" width="140" height="170" border="0"></a></div></td>    
       </tr>
            ...
            <tr>
              <td><div style="line-height:1.6">&nbsp;&nbsp;&nbsp;&nbsp;
                    <?php
						 ...
						 echo msubstr($infobj["content"],0,300);						
				   ...
				   if($i==1)
				    {
					  echo "<font color=red>";
						...
						echo msubstr($infouwz["question"],0,12);
            ...
            <td height="80" colspan="2" valign="top"><table width="275" height="22" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td width="302" height="22" style="padding:5"><a href="jszc.php?jszc=查看常见问题&id=<?php echo $infouwz["id"];?>" class="a1">
                    <?php 						
						echo msubstr($infouwz["question"],0,24);
				   ...
				   if($i==1)
				    {
					  echo "<font color=red>";
						...
						echo msubstr($infouwz["title"],0,12);
				 ...
				 ?>
                    ...
                    <td width="302" height="22" style="padding:5"><a href="bbs_lookbbs.php?id=<?php echo $infouwz["id"];?>" class="a1">
                      <?php 
						...
						echo msubstr($infouwz["title"],0,24);
				   ...
				   if($i==1)
				    {
					  echo "<font color=red>";
						...
						echo msubstr($infouwz["name"],0,12);
