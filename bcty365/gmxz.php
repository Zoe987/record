...
<table width="750" height="60" border="0" align="center" cellpadding="0">
      ...
      <table width="680" height="22" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
        <tr>
          <td bgcolor="#FFFFFF">&nbsp;<img src="images/menubar_left[1].gif" />&nbsp;<?php echo  $infob["bccdname"];?></td>
        </tr>
      </table>
	  <br>
	   ...
	   ?>
	    <tr>
		  ...
		  <?php
		   ...
		   echo $info0["bbname"];
		  ?>		  </td>
          <td height="22" bgcolor="#FFFFFF">&nbsp;<?php echo $infoq["gn"];?></td>
          <td height="22" bgcolor="#FFFFFF">&nbsp;<?php echo $infoq["fw"];?></td>
